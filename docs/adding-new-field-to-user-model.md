...
```php
class User extends \grobledo\user\models\User
{
...
You should override view file `@grobledo/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
...
```php
class RegistrationForm extends \grobledo\user\models\RegistrationForm
{
    /**
     * @var string
     */
