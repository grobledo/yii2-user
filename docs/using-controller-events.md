...
```php
'user' => [
    'class' => \grobledo\user\Module::className(),
    'controllerMap' => [
        'registration' => [
            'class' => \grobledo\user\controllers\RegistrationController::className(),
            'on ' . \grobledo\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function ($e) {
...
```php
\yii\base\Event::on(
    \grobledo\user\controllers\RegistrationController::className(),
    \grobledo\user\controllers\RegistrationController::EVENT_AFTER_CONFIRM,
    function () {        
